...
\begin{figure}[!htbp]
\begin{center}
\subfigure[]{ \input{Images/epslatex/theta_large.tex} \label{fig:theta_large} }
\subfigure[]{ \input{Images/epslatex/p_theta_large.tex} \label{fig:p_theta_large} }
\end{center}
% \vspace*{-0.5cm}
...
\begin{figure}[!htbp]
\begin{center}
\subfigure[]{ \input{Images/epslatex/phi_prime.tex} \label{fig:phi_prime} }
% \hspace*{-0.5cm}
\subfigure[]{ \input{Images/epslatex/psi_prime.tex} \label{fig:psi_prime} }
\end{center}
% \vspace*{-0.5cm}
...
\begin{figure}[!htbp]
\begin{center}
\subfigure[Super-critical, $m < m_{c}$]{ \input{Images/epslatex/sup_phase.tex} \label{fig:super} }
% \hspace*{-0.5cm}
...
\begin{figure}[!htbp]
\begin{center}
\input{Images/epslatex/nonaligned_phase.tex} 
\end{center}
...
\subfigure[][]{ \input{Images/epslatex/kov_n3.tex} \label{fig:kov_n3} }
...
\begin{figure}[!htbp]
\begin{center}
\input{Images/epslatex/Mel_aniso_m.tex} 
\end{center}
\caption[Anisotropic Mel'nikov integral]{Mel'nikov integral for anisotropic rod with $\nu=1\slash{3}$ and $m = 1.70$, $1.72$, $1.74$, $1.76$, $1.78$, $1.80$ at the homoclinic energy level. \label{fig:Mel_aniso_1.75} }
\end{figure}
% 
...
\subfigure[][$\kappa_{0}=0.01$]{  \input{Images/epslatex/Poincare_kappa_0.01.tex} \label{fig:curv_poincare_0.010} }
\subfigure[][$\kappa_{0}=0.015$]{ \input{Images/epslatex/Poincare_kappa_0.015.tex} \label{fig:curv_poincare_0.015} }
\subfigure[][$\kappa_{0}=0.02$]{  \input{Images/epslatex/Poincare_kappa_0.02.tex} \label{fig:curv_poincare_0.020} }
...
Poincar\'e sections for initially curved rods on the unperturbed homoclinic energy level $h=1\slash m^{2}$ for varying levels of $\kappa_{0}$ on the hypersection determined by $\cos\phi=0$. \label{fig:poincare_curv}}
\end{figure} % 
%
...
\begin{figure}[h!tbp] 
\begin{center}
\subfigure[][]{ \input{Images/epslatex/multi_rho.tex} \label{fig:multi_rho} }
...
\begin{figure}[h!tbp] 
\begin{center}
\input{Images/epslatex/lp_rho_m_variety.tex} 
\end{center}
